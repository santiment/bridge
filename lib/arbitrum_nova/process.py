...
from lib.constants import LOG_FREQUENCY, ETHEREUM, ARBITRUM_NOVA
from lib.arbitrum_nova.constants import ARB_BRIDGE
...
def build_event(event):
    ...
    if action == "withdraw":
        chain_in, chain_out = ETHEREUM, ARBITRUM_NOVA
    elif action == "deposit":
        chain_in, chain_out = ARBITRUM_NOVA, ETHEREUM
