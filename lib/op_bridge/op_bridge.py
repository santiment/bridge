"""OP Bridge Exporter Class"""
import logging
from lib.exporter import Exporter
from lib.op_bridge.query import build_events_query
from lib.op_bridge.process import process

class OPBridgeExporter(Exporter):
    """
    OP bridge Exporter Class, used to export transactions
    ...
    def run(self):
        """The main function to run the OP bridge exporter"""
        self.start_logging()
